...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (window.scrollY >= servicesTop - 80) {
        setIsServices(true);
      } else {
        setIsServices(false);
      }
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <a href="#" className="text-white text-2xl font-black tracking-tight">
            Barath<span className="text-red-500">.</span>
          </a>
        </div>
        ...
        <div className="hidden md:block">
          <a
            href="https://drive.google.com/file/d/1mnSW9vrJfizDokw_bIhioBsbJ5kGEr0T/view?usp=drive_link"
      ...
      >
        <div className="flex flex-col px-6 space-y-4">
          ...
          <div className="pt-4 pb-2">
            <a
              href="https://drive.google.com/file/d/1EvVEzjSOaOLdURBoGSE4vO94s0lqI_ND/view?usp=sharing"
              onClick={() => setIsOpen(false)}
